...
const AllPageWatched: React.FC<allWatchedPageProps> = ({ openInfoModal }) => {
  ...
  const allWatched = watchList.filter((item) => item.status === "Watched");
  ...
  return (
    <div className="relative z-30 xl:px-60 lg:px-60 md:px-32 sm:px-10 px-10 py-10">
      ...
      <h3 className="responsive-h3 text-white font-bold pb-6">Watched</h3>
